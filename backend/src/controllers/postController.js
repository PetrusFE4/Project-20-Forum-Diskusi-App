    ...
    try {
        ...
        if (attachments) {
            ...
            for (const attachment of attachments) {
                ...
                const tmpPath = path.resolve(__dirname, '../../../frontend/dist', 'uploads', 'tmp', attachment.file)
                const newPath = path.resolve(__dirname, '../../../frontend/dist', 'uploads', 'post', filename)
